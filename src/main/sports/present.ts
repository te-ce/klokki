...
/** The platform half of a Sports alert — mirrors `AlertSurface`. */
...
/**
 * Both halves of a Sports alert: the notification is missed under Do Not
 * Disturb or a fullscreen app, so the overlay is shown even when the
 * notification fails.
 */
