...
describe('generateIcons', () => {
  ...
  it('produces an .icns that macOS itself can unpack', () => {
  ...
  it('writes menubar templates at the two sizes a menubar asks for', () => {
    const size = (path: string) =>
      execFileSync('/usr/bin/sips', ['-g', 'pixelWidth', path], {
        encoding: 'utf8',
